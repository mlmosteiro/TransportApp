...
public class TransportAppDB extends SQLiteOpenHelper {
    ...
    private static final String createProposalsTable = "CREATE TABLE " +
            ...
            "FOREIGN KEY (" + Contracts.proposalsEntry.idShipment + ") REFERENCES " + Contracts.shipmentAnnouncementEntry._ID +
            "FOREIGN KEY (" + Contracts.proposalsEntry.idTransport + ") REFERENCES " + Contracts.transportAnnouncementEntry._ID +
    ...
    private static final String createShipmentAnnouncementTable = "CREATE TABLE " +
            ...
            "FOREIGN KEY (" + Contracts.shipmentAnnouncementEntry.user + ") REFERENCES " + Contracts.usersEntry._ID +
